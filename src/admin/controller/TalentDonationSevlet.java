...
/**
 * 관리자 - 재능기부 클래스 관리 서블릿 200621 박주이
 */
...
public class TalentDonationSevlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Paging paging = adminService.getPagingTalent(req);
		
		List<Map<String, Object>> list = adminService.selectAllTalentDonationClass(paging);
