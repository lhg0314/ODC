...
//			System.out.println("/admin/class/post [GET]");
			...
			Paging paging = adminService.getPagingCheckClass(req);
//			System.out.println("BoardListController =" + paging);
			
			// DB에서 클래스 정보 꺼내오기
//			map = adminService.selectAllClass();
			List<Map<String, Object>> list = adminService.selectAllClassCheck(paging);
...
//			System.out.println(map);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		adminService.updateClassCheck(classInfo);
