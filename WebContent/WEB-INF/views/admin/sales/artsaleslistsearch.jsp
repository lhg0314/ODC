...
<tr >
	<td>${nowartsearch.bookingNo }</td>
	<td>${nowartsearch.userid }</td>
	<td>${nowartsearch.classname }</td>
	<td><fmt:formatDate value="${nowartsearch.paymentDate }" pattern="yyyy-MM-dd"/></td>
	<td><fmt:formatDate value="${nowartsearch.bookingDate }" pattern="yyyy-MM-dd"/></td>
	<td>${nowartsearch.bookingCount }</td>
	<td><fmt:formatNumber pattern="#,###" value="${nowartsearch.totalPrice }" /></td>
	<td><fmt:formatNumber pattern="#,###" value="${(nowartsearch.totalPrice)*0.9 }" /></td>
