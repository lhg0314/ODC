...
<small>${classname }클래스를 수강한 오디분들이 작성해주신 글 후기 게시판입니다.</small>
</div>
<hr>
...
<!-- 후기가 없을 때  -->
<c:if  var="searchpho" test="${empty searchreviewboardcont }">
...
<!--후기가 있을 때 -->
<c:if  var="content" test="${!empty searchreviewboardcont }">
<!-- 값 출력 -->
<c:forEach items="${searchreviewboardcont }" var="content" >
...
<div class="clearfix"></div>
<!-- 페이징 -->
<c:import url="/WEB-INF/paging/reviewboardsearchcontent.jsp"></c:import>
<br>
